...
const FindDonor = () => {
  ...
  const handleRequest = async () => {
    ...
    axiosPublic
      .post(`/req-donor-blood/${user.email}`, {
  ...
  return (
    <div className="pb-20">
      <Helmet>
        ...
        <meta
          name="description"
          content="Search and find blood donors near you quickly and easily with Blood Wave. Filter donors by blood group, district, or area to meet urgent blood requests effectively."
        />
        <meta
          name="keywords"
          content="find blood donor, blood group search, blood donation, emergency blood donor, local blood donors, urgent blood request, Blood Wave"
        />
        ...
        <meta
          property="og:title"
          content="Find Blood Donors Near You | Blood Wave"
        />
        <meta
          property="og:description"
          content="Quickly search blood donors near you. Filter by blood group and district. Help save lives with Blood Wave."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://blood-wave.netlify.app/donors"
        />
        <meta
          property="og:image"
          content="https://blood-wave.netlify.app/logo-blood-wave.png"
        />
      ...
      <div className="py-10 w-full flex flex-col md:flex-row justify-center gap-5 px-5 md:px-10 bg-rose-200 mb-10 ">
        <select
          className="w-full px-4 py-2 border rounded focus:outline-none bg-red-100 "
          value={bloodGroup}
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 px-5 md:px-10 pb-10 ">
        {donors?.data?.map((donor) => (
          <div
            key={donor._id}
            className="relative bg-gradient-to-br from-red-300 via-black/0 to-red-300 text-white rounded-sm shadow-lg border border-red-200 p-5 w-full max-w-md mx-auto flex flex-col justify-between"
          >
            {/* Availability Badge */}
            <span
              className={`absolute top-1 right-1 border text-xs capitalize font-semibold px-3 py-1 rounded-full shadow-sm  ${
            ...
            <div className="flex items-center gap-4">
              <img
                src={donor.image || "https://i.ibb.co/Fk1ZpJWV/blood-wave.png"}
                alt={donor.name}
            ...
            <div className="mt-5 flex flex-col md:flex-row gap-3">
              ...
              >
                <a
                  ...
                  className={`inline-block w-full text-center font-semibold py-2 px-4 rounded-xl transition-all duration-200 ${
                    donor.phoneVisibility === "public"
                      ? "bg-green-500 hover:bg-green-600 text-white cursor-pointer"
                      : "bg-red-500 text-white cursor-not-allowed"
                  }`}
                  onClick={(e) => {
                    if (donor.phoneVisibility !== "public") {
                      e.preventDefault();
                    }
                  }}
                >
              ...
              <div className="fixed inset-0 bg-black/20 bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-gradient-to-tl from-red-100 to-red-200 text-black rounded p-6 w-full max-w-md">
                  <h2 className="text-xl mb-4 font-semibold text-center">
                    Send Blood Request to {selectedDonor.name}
                  </h2>
                  ...
                  <label className="block mb-2">
                    ...
                    Message:
                    <textarea
                      className="w-full border-2 p-2 rounded duration-300 focus:outline-none focus:border-2 focus:border-red-400"
                      value={message}
                  ...
                  <div className="flex justify-end gap-4">
                    <button
                      ...
                      className="px-4 py-2 rounded  bg-red-500 border text-white hover:bg-red-600/80 duration-300 hover:scale-x-110 cursor-pointer"
                    >
                      Cancel
                    </button>
                    <button
                      onClick={handleRequest}
                      className="px-4 py-2 rounded bg-green-500 text-white hover:bg-green-600/90 duration-300 hover:scale-x-90 cursor-pointer"
                    >
                      Send Request
                    </button>
                  </div>
      ...
      <div className="flex justify-center items-center gap-4 mt-6">
        <button
          ...
          className="px-4 py-2 rounded bg-green-500 text-white disabled:bg-gray-400 hover:bg-green-600 transition"
        >
          Previous
        </button>
        ...
        <button
          disabled={
            !donors?.data || page * limit >= donors.activeTotal || isFetching
          }
