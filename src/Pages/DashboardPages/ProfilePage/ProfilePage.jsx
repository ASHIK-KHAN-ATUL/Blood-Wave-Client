...
const ProfilePage = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="max-w-3xl mx-auto p-6 bg-gradient-to-br from-[#eb464662] via-[#fcc7df83] to-[#9cf5f59a] rounded shadow-md mt-10 relative"
        initial={{ scale: 0.95 }}
        animate={{ scale: 1 }}
        transition={{ duration: 0.5 }}
      >
        ...
        <div className="absolute top-1 right-1">
          <Link
            ...
            className="btn btn-xs text-white bg-gradient-to-br from-red-500 via-black to-sky-500"
          >
            Edit
          </Link>
        </div>
        ...
        <motion.div
          className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm"
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.4 }}
        >
          <p>
            <strong>Status:</strong> {mainUser.status}
          </p>
          <p>
            <strong>Phone:</strong> {mainUser.phone}
          </p>
          <p>
            <strong>Phone Visibility:</strong> {mainUser.phoneVisibility}
          </p>
          <p>
            <strong>Blood Group:</strong> {mainUser.bloodGroup}
          </p>
          <p>
            <strong>Availability:</strong> {mainUser.availability}
          </p>
          <p>
            <strong>Gender:</strong> {mainUser.gender}
          </p>
          <p>
            <strong>Area:</strong> {mainUser.area}
          </p>
          <p>
            <strong>District:</strong> {mainUser.district}
          </p>
          <p>
            <strong>Division:</strong> {mainUser.division}
          </p>
          <p>
            <strong>Message:</strong> {mainUser.message || "-"}
          </p>
          <p>
            <strong>Joined:</strong>{" "}
            {new Date(mainUser.createAt).toLocaleDateString()}
          </p>
        </motion.div>
      </motion.div>
    </motion.div>
