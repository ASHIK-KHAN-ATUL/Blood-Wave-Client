  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#fff1f1] py-12 px-4">
      ...
      <div className="w-full max-w-xl bg-gradient-to-br to-rose-300 from-red-200  p-8 rounded-xl shadow-lg">
        <h2 className="text-3xl font-bold text-[#e50914] mb-6 text-center">
          Register on Blood-Wave
        </h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            <label className="fieldset-label text-red-600 font-bold">
              Upload Photo
            </label>
            <div className=" border border-red-600 p-2 border-dashed mt-2">
              <input
                ...
                name="image"
                accept="image/*"
                className="file-input bg-gradient-to-br to-rose-300 from-red-200  text-red-600 file:bg-red-500 w-full "
              />
            </div>
            {errors.image && (
            ...
            <input
              ...
              {...register("password", {
                ...
                pattern: {
                  value: /^(?=.*[A-Z])(?=.*[a-z])(?=.*\d).{6,}$/,
                  message:
                    "Must contain at least one uppercase letter one lowercase and one number",
                },
              })}
              className="w-full px-4 py-2 border-b focus:outline-none"
            />
          ...
          <button
            type="submit"
            className="w-full bg-[#e50914] text-white font-semibold py-2 rounded-lg hover:bg-[#c1070f] transition-all cursor-pointer hover:scale-x-90 duration-500"
          >
            Register
          </button>
        </form>
